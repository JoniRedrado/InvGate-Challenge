...
import { TopRightArrow } from './svg/svgIcons'
      ...
      <div id='grid' className='flex flex-col lg:flex-row gap-4'>
        ...
        <div id='little-cards-container' className='lg:w-1/2 flex flex-col gap-4 justify-between' >
        {
          filteredBlogPosts.map((post, index) => {
            ...
            return (<div id='little-card-1' className='flex flex-col py-5 px-1 sm:flex-row max-h-1/2' key={index}>
              <div className=' sm:w-1/2  overflow-hidden w-full md:h-full'>
                <img src={post.image} className=' rounded-2xl w-full h-full object-cover'/>
              </div>
